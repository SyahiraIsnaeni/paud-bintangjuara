...
<head>
    ...
    <style>
        .banner {
            background: url("{{asset('front/masjid.png')}}") no-repeat center center;
...
<section id="jumbotron">
    <div class="container-fluid banner fixed-down">
        <div class="container text-start">
            <h1 class="display-5" style="text-shadow: 2px 2px 10px #000000;"><b>Yuk Wakaf</b></h1>
            <h4 style="text-shadow: 2px 2px 10px #000000;">Untuk pembebasan lahan guna membangun Mushola dan mengembangkan PAUD Islam
                Bintang Juara</h4>
